          ...
          <Table className="w-full text-sm mb-4">
            ...
            <TableBody>
              {items.map((item) => {
                ...
                const quantity = item.returnQuantity || item.quantity || 0;
                const price = item.product?.sellingPrice || 0;
                
                return (
                  <TableRow key={item.id}>
                    <TableCell className="py-2">{displayName}</TableCell>
                    <TableCell className="text-center py-2">{quantity}</TableCell>
                    <TableCell className="text-right py-2">${price.toFixed(2)}</TableCell>
